...
Noeud* nouvel_arbre(Situation s, int joueur_a_max, int profondeur);
 ...
 * calcule la valeur de tous les noeuds. Donne le coup à jouer. */
int eval_arbre(Noeud* racine);

/* Fonction récursive utilisée pour l'évaluation. Implémentation réelle de minmax.*/
int eval_arbre_rec(Noeud* racine, int joueur_a_maximiser);
